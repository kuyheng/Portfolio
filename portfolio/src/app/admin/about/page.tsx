  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Card className="p-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-400">Polished cards showing your strengths.</p>
          </div>
          <div className="flex flex-wrap items-center gap-2">
            <Button
              type="button"
              variant={draft.features.enabled ? "secondary" : "outline"}
              onClick={() =>
                setDraft((prev) => ({
                  ...prev,
                  features: { ...prev.features, enabled: !prev.features.enabled },
                }))
              }
            >
              {draft.features.enabled ? "Enabled" : "Disabled"}
            </Button>
            <Button
              type="button"
              onClick={() =>
        ...
        <div className="mt-4 grid gap-3">
          {draft.features.items.map((item, index) => (
            <div key={item.id} className="rounded-xl border border-slate-800 bg-slate-900/60 p-4">
              <div className="grid gap-3 md:grid-cols-[1.1fr_1.1fr_0.6fr]">
                <Input
                  placeholder="Title"
                  value={item.title}
                  onChange={(event) =>
                    setDraft((prev) => ({
                      ...
                      features: {
                        ...prev.features,
                        items: prev.features.items.map((entry) =>
              ...
              <div className="mt-3 flex items-center justify-end gap-2">
                <Button
                  ...
                  onClick={() =>
                    setDraft((prev) => ({
                      ...
                      features: {
                        ...prev.features,
                        items: moveItem(prev.features.items, index, -1),
                      },
                    }))
                  }
                  disabled={index === 0}
                ...
                <Button
                  ...
                  disabled={index === draft.features.items.length - 1}
                >
                  <ArrowDown className="h-4 w-4" />
                </Button>
                <Button
                  ...
                  onClick={() =>
                    setDraft((prev) => ({
                      ...
                      features: {
                        ...prev.features,
                        items: prev.features.items.filter((entry) => entry.id !== item.id),
                      },
                    }))
                  }
                >
      ...
      <Card className="p-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h3 className="text-base font-semibold text-white">Journey / Timeline</h3>
            <p className="text-sm text-slate-400">Path cards in the About section.</p>
          </div>
          <div className="flex flex-wrap items-center gap-2">
            <Button
              type="button"
              variant={draft.journey.enabled ? "secondary" : "outline"}
              onClick={() =>
                setDraft((prev) => ({
                  ...prev,
                  journey: { ...prev.journey, enabled: !prev.journey.enabled },
                }))
              }
            >
              {draft.journey.enabled ? "Enabled" : "Disabled"}
            </Button>
            <Button
              type="button"
              onClick={() =>
                setDraft((prev) => ({
                  ...
                  journey: {
                    ...
                    items: [
                      ...prev.journey.items,
                      { id: createId("journey"), label: "New", title: "", detail: "" },
                    ],
                  },
                }))
              }
        ...
        <div className="mt-4 grid gap-3">
          {draft.journey.items.map((item, index) => (
            <div key={item.id} className="rounded-xl border border-slate-800 bg-slate-900/60 p-4">
                ...
                <Input
                  ...
                  onChange={(event) =>
                    setDraft((prev) => ({
                      ...
                      journey: {
                        ...prev.journey,
                        items: prev.journey.items.map((entry) =>
                          entry.id === item.id ? { ...entry, label: event.target.value } : entry
                        ),
                      },
                    }))
              ...
              <div className="mt-3 flex items-center justify-end gap-2">
                <Button
                  ...
                  onClick={() =>
                    setDraft((prev) => ({
                      ...prev,
                      journey: { ...prev.journey, items: moveItem(prev.journey.items, index, -1) },
                    }))
                  }
                  disabled={index === 0}
                >
                ...
                <Button
                  ...
                  disabled={index === draft.journey.items.length - 1}
                >
                  <ArrowDown className="h-4 w-4" />
                </Button>
                <Button
                  ...
                  onClick={() =>
                    setDraft((prev) => ({
                      ...
                      journey: {
                        ...prev.journey,
                        items: prev.journey.items.filter((entry) => entry.id !== item.id),
                      },
                    }))
                  }
                >
      ...
      <Card className="p-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h3 className="text-base font-semibold text-white">Toolbox</h3>
            <p className="text-sm text-slate-400">Tech stack pills in the About section.</p>
          </div>
          <div className="flex flex-wrap items-center gap-2">
            <Button
              type="button"
              variant={draft.toolbox.enabled ? "secondary" : "outline"}
              onClick={() =>
                setDraft((prev) => ({
                  ...prev,
                  toolbox: { ...prev.toolbox, enabled: !prev.toolbox.enabled },
                }))
              }
            >
              {draft.toolbox.enabled ? "Enabled" : "Disabled"}
            </Button>
            <Button
              type="button"
              onClick={() =>
                setDraft((prev) => ({
                  ...
                  toolbox: {
                    ...prev.toolbox,
                    items: [...prev.toolbox.items, { id: createId("tool"), label: "New Tool" }],
                  },
                }))
              }
            >
        ...
        <div className="mt-4 grid gap-4">
          <Input
            ...
            value={draft.toolbox.title}
            onChange={(event) =>
              setDraft((prev) => ({
                ...prev,
                toolbox: { ...prev.toolbox, title: event.target.value },
              }))
            }
          />
          <Textarea
            placeholder="Toolbox description"
            value={draft.toolbox.description || ""}
            onChange={(event) =>
              setDraft((prev) => ({
                ...prev,
                toolbox: { ...prev.toolbox, description: event.target.value },
              }))
            }
          />
          <div className="grid gap-3">
            {draft.toolbox.items.map((item, index) => (
              <div key={item.id} className="rounded-xl border border-slate-800 bg-slate-900/60 p-4">
                <div className="flex flex-wrap items-center gap-3">
                  <Input
                    ...
                    onChange={(event) =>
                      setDraft((prev) => ({
                        ...
                        toolbox: {
                          ...prev.toolbox,
                          items: prev.toolbox.items.map((entry) =>
                            entry.id === item.id ? { ...entry, label: event.target.value } : entry
                          ),
                        },
                      }))
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      onClick={() =>
                        setDraft((prev) => ({
                          ...
                          toolbox: {
                            ...prev.toolbox,
                            items: moveItem(prev.toolbox.items, index, -1),
                          },
                        }))
                      }
                      disabled={index === 0}
                    ...
                    <Button
                      ...
                      disabled={index === draft.toolbox.items.length - 1}
                    >
                      <ArrowDown className="h-4 w-4" />
                    </Button>
                    <Button
                      ...
                      onClick={() =>
                        setDraft((prev) => ({
                          ...
                          toolbox: {
                            ...prev.toolbox,
                            items: prev.toolbox.items.filter((entry) => entry.id !== item.id),
                          },
                        }))
                      }
                    >
